...
function GeonosianLab:spawnMobiles()
	...
	spawnMobile("yavin4", "enhanced_gaping_spider",600,-130,-22.1,-85,-180,1627794, false) -- Randomized respawn
	...
	spawnMobile("yavin4", "acklay",600,101.1,-34.3,-321.6,-136,1627823, false) --Randomized respawn
