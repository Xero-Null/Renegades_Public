...
object_weapon_ranged_heavy_heavy_acid_beam = object_weapon_ranged_heavy_shared_heavy_acid_beam:new {
	...
	creatureAccuracyModifiers = { "heavy_acid_beam_accuracy", "heavyweapon_accuracy" },
	...
	speedModifiers = { "heavy_acid_beam_speed", "heavyweapon_speed" },
	...
	experimentalMin = {0, 0, 833, 1500, 8.7, 19, 30, 750, 0, 0, 25, 20, 25, 78, 78, 20},
	experimentalMax = {0, 0, 1057, 3700, 4.4, 35, 65, 1500, 5, 5, 75, 30, 50, 42, 42, 10},
