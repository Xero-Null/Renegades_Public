...
object_weapon_ranged_heavy_heavy_particle_beam = object_weapon_ranged_heavy_shared_heavy_particle_beam:new {
	...
	creatureAccuracyModifiers = { "heavy_particle_beam_accuracy", "heavyweapon_accuracy" },
	...
	speedModifiers = { "heavy_particle_beam_speed", "heavyweapon_speed" },
	...
	experimentalMin = {0, 0, 1860, 2100, 9.1, 10, 30, 750, 0, 0, 25, 0, 25, 33, 110, 33},
	experimentalMax = {0, 0, 2000, 3700, 4, 20, 65, 1500, 5, 5, 75, 60, 50, 17, 59, 17},
