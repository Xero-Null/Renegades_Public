...
void SceneObjectImplementation::rotate(float degrees) {
	Vector3 unity(0, 1, 0);
	direction.rotate(unity, degrees);
}

void SceneObjectImplementation::rotateX(float degrees) {
	Vector3 unity(1, 0, 0);
	direction.rotate(unity, degrees);
}

void SceneObjectImplementation::rotateY(float degrees) {
	Vector3 unity(0, 0, 1);
	direction.rotate(unity, degrees);
}
